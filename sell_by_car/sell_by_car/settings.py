...
# В данном файле описываются все глобальные настройки сайта
...
WSGI_APPLICATION = 'sell_by_car.wsgi.application'
...
# User
# AUTH_USER_MODEL = 'main.ExtraUser'
